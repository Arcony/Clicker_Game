...
var spiders =
    {
        ...
        tileMax:5,
        timer:2,
        tileActive : [ false , false , false , false , false ],
    }
        ...
        monsterTab.forEach(function(element) {
            ...
            if( element.unlock )
            {
               var divrow = '<div class="row" id= "'+element.nameSingle+'Div">';
                ...
                {
                    var elemTile = '<div class="tile" onclick="buyMonster('+element.name+')" id="'+element.nameSingle+'Tile'+i+'"><div id='+element.nameSingle+'TileBar'+i+'  class="myBar"><div id ='+element.nameSingle+'Tiletext'+i+' class="labely padding_label">'+element.timer+' </div> </div></div>';
            ...
            else
            {
                ...
                for(var i=0 ; i < element.tileMax ; i++)
                {
                    var elemTile = '<div class="tile invisible" onclick="buyMonster('+element.name+')" id="'+element.nameSingle+'Tile'+i+'"><div id='+element.nameSingle+'TileBar'+i+'  class="myBar"><div id ='+element.nameSingle+'Tiletext'+i+' class="labely padding_label">'+element.timer+' </div> </div></div>';
                    $('#'+element.nameSingle+'Div3').append(elemTile);
                }
            }
...
function unlock(monster){
    if(golds >= monster.unlockCost)
    {
        ...
        $('#'+monster.nameSingle+'Tile0').removeClass("invisible");
        document.getElementById('golds').innerHTML = prettify(golds);
...
function progress(elem , text , timerMonster , monster , temp)
{
    ...
    console.log( elem+" "+text+" "+ timerMonster + " "+ monster+ " " + temp);
    var timer = 0,
        perc = 0,
...
{
    console.log('buyMonster');
    if( golds >= monster.nextCost )
    {
        console.log('buyMonster2');
        var temp = checkFirstTileActive(monster);

        if(temp >= 0 )
        {
            console.log('buyMonster3');
